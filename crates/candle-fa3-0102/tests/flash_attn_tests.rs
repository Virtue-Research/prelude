...
// Crate was renamed candle-flash-attn-v3 -> candle-fa3-0102 (lib candle_fa3_0102)
// for isolation; alias it back so this upstream test's paths resolve unchanged.
use candle_fa3_0102 as candle_flash_attn_v3;
use rstest::rstest;
