...
extern "C" void run_mha(
    ...
    // Global tile counter for the DynamicPersistentTileScheduler (causal/local). Caller
    // (candle binding) passes a zero-initialized int32; without it this stays NULL after
    // the memset above and the causal kernel does an illegal atomicAdd on a null pointer.
