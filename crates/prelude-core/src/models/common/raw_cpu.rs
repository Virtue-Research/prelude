...
use crate::ops::onednn::OnednnF32PackedWeight;
    ...
    unsafe fn fused_work(tid: usize, n_threads: usize, ctx_raw: *const u8) {
        unsafe {
            ...
            );
            {
                ...
                crate::ops::cpu::rmsnorm::rmsnorm_generic(
            ...
            for t in t_start..t_end {
                ...
                for h in 0..ctx.num_heads {
                    let off = h * hd;
                    crate::ops::cpu::rope::rope_neox_row_f32(
...
pub(crate) fn raw_prefill_attention_f32(
    ...
    work_items.par_iter().for_each(|w| {
        ...
        // Softmax
        crate::ops::cpu::softmax::softmax_f32_inplace(&mut scores, slen, slen);
