...
struct Flash_fwd_params : public Qkv_params {
    ...
    // Optional Q prologue fusion (Plan A): RMSNorm + RoPE on Q in SMEM before Q@K.
    void * __restrict__ q_norm_weight_ptr;
    float q_norm_eps;
    int * __restrict__ position_ids_ptr;
    bool fuse_q_norm_rope;
    int fuse_num_q_heads;
