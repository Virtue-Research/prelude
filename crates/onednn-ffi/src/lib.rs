...
unsafe extern "C" {
    ...
    pub fn brgemm_bf16_pack(weight: *const c_void, k: i64, n: i64) -> *mut c_void;
    ...
    pub fn brgemm_s8_pack(weight: *const i8, scales: *const f32, k: i64, n: i64) -> *mut c_void;
