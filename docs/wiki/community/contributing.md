...
AGInfer is an early-stage open source project and contributions are very welcome. This page covers how to get started.

## Getting Help / Reporting Issues

- **GitHub Issues** — open an issue at `opensage-agent/aginfer` with steps to reproduce, expected behavior, and relevant logs
...
- Keep dependencies minimal — AGInfer aims for small binary size and few runtime deps
