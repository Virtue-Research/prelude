...
- **Engines**: Prelude (native binary), vLLM 0.18.0 (Docker), SGLang (Docker)
...
SGLang and vLLM run in Docker containers (`lmsysorg/sglang:latest`, `vllm/vllm-openai:latest`). Prelude runs as a native binary.
...
|---|---|---|---|---|---|---|
| H200 | **Prelude** | **4** | **0.0068** | **0.0069** | **14,520.9** | **6,514.8** |
...
**H200**: Prelude vs vLLM — **1.46× RPM, 1.57× lower TTFT, 15× faster startup**
**H200**: Prelude vs SGLang — **4.69× RPM, 5.99× lower TTFT**
...
|---|---|---|---|---|---|---|
| H200 | **Prelude** | **2** | **0.0135** | 0.0441 | 92.0 | 172.5 |
...
| GPU | Engine | Startup (s) | TTFT (s) | TPOT (s) | Output tok/s | RPM |
|---|---|---|---|---|---|---|
| H200 | **Prelude** | 14 | **0.0178** | 0.0442 | 91.4 | 171.3 |
