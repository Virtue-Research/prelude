...
Usage examples:
  python benchmark/prelude/benchmark.py classify \\
  ...
  python benchmark/prelude/benchmark.py embed \\
  ...
  python benchmark/prelude/benchmark.py mix \\
    --prefill-weight 0.7 --gen-weight 0.3 --max-tokens 32 --rerun 3 \\
    --url http://localhost:8000 --model mymodel --concurrency 1,4,16

  python benchmark/prelude/benchmark.py --config bench.toml
"""
